...
<ExerciseGrid
  ...
  items={[
    { num: "01", name: "Filtra un array de números pares", diff: "easy", minutes: 3 },
    { num: "02", name: "Transforma un array de objetos con map", diff: "easy", minutes: 4 },
    { num: "03", name: "Desestructura un objeto anidado", diff: "med", minutes: 5 },
    { num: "04", name: "Fusiona dos objetos con spread", diff: "med", minutes: 4 },
    { num: "05", name: "reduce para calcular un total", diff: "med", minutes: 6 },
  ]}
/>
</Section>
