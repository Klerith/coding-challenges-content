...
<ExerciseGrid
  items={[
    { num: "01", name: "Convierte .then()/.catch() a async/await", diff: "easy", minutes: 5 },
    { num: "02", name: "Función async que obtiene y transforma datos", diff: "med", minutes: 8 },
    { num: "03", name: "Manejo de errores con try/catch en async", diff: "med", minutes: 8 },
    { num: "04", name: "Múltiples awaits secuenciales vs paralelos", diff: "med", minutes: 10 },
    { num: "05", name: "API wrapper con tipos TypeScript", diff: "hard", minutes: 12 },
  ]}
/>
</Section>
