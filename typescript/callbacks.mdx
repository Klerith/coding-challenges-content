...
<ExerciseGrid
  items={[
    { num: "01", name: "Crea una función que acepte un callback de éxito y error", diff: "easy", minutes: 5 },
    { num: "02", name: "Simula una llamada a API con setTimeout", diff: "med", minutes: 8 },
    { num: "03", name: "Convierte callback hell a funciones separadas", diff: "med", minutes: 10 },
    { num: "04", name: "Implementa un sistema de eventos simple", diff: "hard", minutes: 12 },
  ]}
/>
</Section>
