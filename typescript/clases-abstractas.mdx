...
<ExerciseGrid
  items={[
    { num: "01", name: "Clase abstracta Figura con area() abstracto", diff: "easy", minutes: 8 },
    { num: "02", name: "Implementa Circulo y Triangulo que extienden Figura", diff: "med", minutes: 10 },
    { num: "03", name: "Abstracta con hook methods (Template Method pattern)", diff: "hard", minutes: 15 },
    { num: "04", name: "Distingue cuándo usar abstract vs interface", diff: "med", minutes: 10 },
  ]}
/>
</Section>
