...
console.log(fibMemo(40)); // 102334155 (rápido)`
    },
    {
      ...
      label: "TypeScript",
      code: `// Factory tipada
function crearLogger(prefijo: string): (msg: string) => void {
  return (msg: string) => console.log(\`[\${prefijo}] \${msg}\`);
}

const errorLog = crearLogger("ERROR");
const infoLog  = crearLogger("INFO");

errorLog("Conexión fallida");   // [ERROR] Conexión fallida
infoLog("Servidor listo");      // [INFO] Servidor listo

// useState de React — internamente usa un closure
// const [count, setCount] = useState(0);
// setCount es una función que "recuerda" la referencia al estado interno`
    }
  ]}
  output={`120\n10\n15`}
/>
