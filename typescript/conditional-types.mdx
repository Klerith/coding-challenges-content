...
<ExerciseGrid
  items={[
    { num: "01", name: "Implementa IsArray con type guard y conditional type", diff: "med", minutes: 10, href: "/problems/typescript-conditional-is-array" },
    { num: "02", name: "Implementa flatten para arrays de cualquier nivel", diff: "med", minutes: 12, href: "/problems/typescript-conditional-flatten" },
    { num: "03", name: "Crea UnwrapArray con infer para normalizar arrays y escalares", diff: "hard", minutes: 15, href: "/problems/typescript-conditional-unwrap-array" },
    { num: "04", name: "Implementa deepFreeze recursivo con Readonly", diff: "hard", minutes: 20, href: "/problems/typescript-conditional-deep-freeze" },
  ]}
/>
</Section>
