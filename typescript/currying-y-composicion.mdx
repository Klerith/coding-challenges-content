...
<ExerciseGrid
  items={[
    { num: "01", name: "Crea una función curry() genérica", diff: "hard", minutes: 15, href: "/problems/typescript-curry-dos-argumentos" },
    { num: "02", name: "Aplicación parcial de fetch con baseURL", diff: "med", minutes: 10, href: "/problems/typescript-aplicacion-parcial" },
    { num: "03", name: "Pipeline de transformación con pipe()", diff: "med", minutes: 10, href: "/problems/typescript-pipeline-con-pipe" },
    { num: "04", name: "Implementa compose() tipado en TypeScript", diff: "hard", minutes: 15, href: "/problems/typescript-implementa-compose" },
  ]}
/>
</Section>
