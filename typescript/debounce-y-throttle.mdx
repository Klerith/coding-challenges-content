...
<ExerciseGrid
  items={[
    { num: "01", name: "Implementa debounce()", diff: "med", minutes: 10, href: "/problems/typescript-implementa-debounce" },
    { num: "02", name: "Implementa throttle()", diff: "med", minutes: 10, href: "/problems/typescript-implementa-throttle" },
    { num: "03", name: "Aplica debounce a una búsqueda", diff: "hard", minutes: 12, href: "/problems/typescript-debounce-busqueda" },
  ]}
/>
</Section>
