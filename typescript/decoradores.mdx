...
<ExerciseGrid
  items={[
    { num: "01", name: "Implementa @Log que registra argumentos y tiempo de ejecución", diff: "med", minutes: 12 },
    { num: "02", name: "Decorador @Validate para propiedades con reglas configurables", diff: "hard", minutes: 15 },
    { num: "03", name: "Decorator factory @Retry(n) que reintenta el método n veces", diff: "hard", minutes: 20 },
  ]}
/>
</Section>
