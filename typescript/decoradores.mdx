...
<ExerciseGrid
  items={[
    { num: "01", name: "HOF: registra llamadas a métodos", diff: "med", minutes: 10, href: "/problems/typescript-hof-log-llamadas" },
    { num: "02", name: "HOF: valida argumentos de una función", diff: "hard", minutes: 12, href: "/problems/typescript-hof-validar-argumentos" },
    { num: "03", name: "HOF: reintenta una función N veces", diff: "hard", minutes: 15, href: "/problems/typescript-hof-retry-n-veces" },
  ]}
/>
</Section>
