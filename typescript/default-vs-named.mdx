...
<ExerciseGrid
  items={[
    { num: "01", name: "Convierte exports nombrados a default y viceversa", diff: "easy", minutes: 5 },
    { num: "02", name: "Crea un barrel file que re-exporta 3 módulos", diff: "med", minutes: 8 },
    { num: "03", name: "Importa con alias para evitar colisiones de nombres", diff: "med", minutes: 8 },
    { num: "04", name: "Reestructura una carpeta usando index.ts", diff: "hard", minutes: 12 },
  ]}
/>
</Section>
