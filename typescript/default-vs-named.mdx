...
<ExerciseGrid
  items={[
    { num: "01", name: "Convierte exports nombrados a export default", diff: "easy", minutes: 5, href: "/problems/typescript-named-a-default-export" },
    { num: "02", name: "Crea un barrel: re-exporta múltiples funciones", diff: "easy", minutes: 6, href: "/problems/typescript-barrel-re-exporta" },
    { num: "03", name: "Usa alias de importación para resolver colisiones", diff: "med", minutes: 8, href: "/problems/typescript-alias-importacion-colision" },
    { num: "04", name: "Reorganiza utilidades en un objeto índice", diff: "med", minutes: 10, href: "/problems/typescript-reorganiza-utilidades-indice" },
  ]}
/>
</Section>
