...
<ExerciseGrid
  items={[
    { num: "01", name: "Extrae 3 propiedades de un objeto con destructuring", diff: "easy", minutes: 3 },
    { num: "02", name: "Renombra propiedades al desestructurar", diff: "easy", minutes: 5 },
    { num: "03", name: "Desestructura con defaults para campos opcionales", diff: "med", minutes: 8 },
    { num: "04", name: "Desestructura objetos anidados", diff: "med", minutes: 8 },
    { num: "05", name: "Función que acepta objeto y destructura en parámetros", diff: "hard", minutes: 10 },
  ]}
/>
</Section>
