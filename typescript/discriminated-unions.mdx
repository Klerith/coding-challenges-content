...
<ExerciseGrid
  items={[
    { num: "01", name: "Modela estados de carga: Loading | Success | Error", diff: "easy", minutes: 8 },
    { num: "02", name: "Switch exhaustivo sobre una union de formas geométricas", diff: "med", minutes: 10 },
    { num: "03", name: "Implementa Result<T, E> con discriminated union", diff: "med", minutes: 12 },
    { num: "04", name: "Sistema de eventos tipados con discriminated unions y handlers", diff: "hard", minutes: 15 },
  ]}
/>
</Section>
