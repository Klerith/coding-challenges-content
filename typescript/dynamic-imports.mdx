...
<ExerciseGrid
  items={[
    { num: "01", name: "Carga un módulo pesado solo cuando el usuario lo solicita", diff: "med", minutes: 10 },
    { num: "02", name: "Implementa lazy loading condicional por entorno", diff: "med", minutes: 10 },
    { num: "03", name: "Dynamic import con manejo de error y retry", diff: "hard", minutes: 12 },
  ]}
/>
</Section>
