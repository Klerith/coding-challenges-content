...
<ExerciseGrid
  items={[
    { num: "01", name: "Simula carga lazy de un módulo con import()", diff: "easy", minutes: 6, href: "/problems/typescript-lazy-load-modulo" },
    { num: "02", name: "Carga condicional de módulo de internacionalización", diff: "med", minutes: 8, href: "/problems/typescript-lazy-load-i18n" },
    { num: "03", name: "Dynamic import con reintentos en caso de error", diff: "hard", minutes: 12, href: "/problems/typescript-dynamic-import-retry" },
  ]}
/>
</Section>
