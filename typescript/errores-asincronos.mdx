...
<ExerciseGrid
  items={[
    { num: "01", name: "Captura errores en una cadena de Promises", diff: "easy", minutes: 6, href: "/problems/typescript-captura-errores-promise-chain" },
    { num: "02", name: "Wrapper try/catch reutilizable para async/await", diff: "med", minutes: 8, href: "/problems/typescript-async-safe-wrapper" },
    { num: "03", name: "Distingue errores de red de errores de datos", diff: "med", minutes: 10, href: "/problems/typescript-distingue-errores-red-datos" },
    { num: "04", name: "Propaga errores personalizados en código async", diff: "hard", minutes: 12, href: "/problems/typescript-propaga-errores-async" },
  ]}
/>
</Section>
