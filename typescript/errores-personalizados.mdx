...
<ExerciseGrid
  items={[
    { num: "01", name: "Crea un NotFoundError con statusCode 404", diff: "easy", minutes: 8 },
    { num: "02", name: "Implementa ValidationError con campo y mensaje", diff: "med", minutes: 10 },
    { num: "03", name: "Cadena de errores personalizados en una API", diff: "hard", minutes: 15 },
    { num: "04", name: "Patrón Result<T, E> alternativo a throw", diff: "hard", minutes: 15 },
  ]}
/>
</Section>
