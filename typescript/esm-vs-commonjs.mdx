...
<ExerciseGrid
  items={[
    { num: "01", name: "Convierte un archivo CJS a ESM puro", diff: "easy", minutes: 5 },
    { num: "02", name: "Configura package.json y tsconfig para ESM en Node.js", diff: "med", minutes: 10 },
    { num: "03", name: "Importa un módulo CJS desde un archivo ESM", diff: "hard", minutes: 15 },
  ]}
/>
</Section>
