...
<ExerciseGrid
  items={[
    { num: "01", name: "Convierte un módulo CommonJS a ES Modules", diff: "easy", minutes: 6, href: "/problems/typescript-cjs-a-esm" },
    { num: "02", name: "Configura la función de configuración ESM correcta", diff: "med", minutes: 8, href: "/problems/typescript-config-esm-tsconfig" },
    { num: "03", name: "Importa un paquete CJS desde un módulo ESM", diff: "med", minutes: 10, href: "/problems/typescript-cjs-desde-esm-createrequire" },
  ]}
/>
</Section>
