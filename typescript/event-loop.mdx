...
<ExerciseGrid
  items={[
    { num: "01", name: "Predice el orden de salida de este código async", diff: "med", minutes: 8 },
    { num: "02", name: "Explica por qué setTimeout 0 no es inmediato", diff: "med", minutes: 10 },
    { num: "03", name: "Usa queueMicrotask para diferir código correctamente", diff: "hard", minutes: 15 },
  ]}
/>
</Section>
