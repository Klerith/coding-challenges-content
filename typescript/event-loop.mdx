...
<ExerciseGrid
  items={[
    { num: "01", name: "Predice el orden de ejecución async/sync", diff: "med", minutes: 8, href: "/problems/typescript-predice-orden-event-loop" },
    { num: "02", name: "Demuestra por qué setTimeout(fn, 0) no es inmediato", diff: "med", minutes: 8, href: "/problems/typescript-settimeout-cero-no-inmediato" },
    { num: "03", name: "Usa queueMicrotask para trabajo prioritario", diff: "hard", minutes: 12, href: "/problems/typescript-queue-microtask" },
  ]}
/>
</Section>
