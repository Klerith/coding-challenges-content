...
<ExerciseGrid
  items={[
    { num: "01", name: "Muestra la fecha actual en formato español largo", diff: "easy", minutes: 5 },
    { num: "02", name: "Calcula la diferencia en días entre dos fechas", diff: "med", minutes: 8 },
    { num: "03", name: "Formatea un precio en MXN con Intl.NumberFormat", diff: "easy", minutes: 5 },
    { num: "04", name: "Muestra 'hace X días' con RelativeTimeFormat", diff: "med", minutes: 8 },
  ]}
/>
</Section>
