...
<ExerciseGrid
  items={[
    { num: "01", name: "Obtén datos de una API pública con fetch", diff: "easy", minutes: 5 },
    { num: "02", name: "Envía un POST con JSON y maneja la respuesta", diff: "med", minutes: 8 },
    { num: "03", name: "Maneja errores HTTP (404, 500) correctamente", diff: "med", minutes: 8 },
    { num: "04", name: "Crea un cliente HTTP genérico tipado", diff: "hard", minutes: 15 },
    { num: "05", name: "Implementa caché simple de requests", diff: "hard", minutes: 15 },
  ]}
/>
</Section>
