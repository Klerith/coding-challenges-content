...
<ExerciseGrid
  items={[
    { num: "01", name: "Obtén datos de una API con fetch simulado", diff: "easy", minutes: 5, href: "/problems/typescript-fetch-obtener-datos" },
    { num: "02", name: "Envía un POST con JSON usando fetch simulado", diff: "easy", minutes: 6, href: "/problems/typescript-fetch-post-json" },
    { num: "03", name: "Maneja errores HTTP 404 y 500 en fetch", diff: "med", minutes: 8, href: "/problems/typescript-fetch-maneja-errores-http" },
    { num: "04", name: "Crea un cliente HTTP genérico tipado", diff: "hard", minutes: 12, href: "/problems/typescript-cliente-http-generico" },
    { num: "05", name: "Implementa una caché simple para requests", diff: "hard", minutes: 15, href: "/problems/typescript-cache-requests-simple" },
  ]}
/>
</Section>
