...
<ExerciseGrid
  items={[
    { num: "01", name: "Busca un usuario por email con find", diff: "easy", minutes: 5, href: "/problems/typescript-busca-usuario-por-email" },
    { num: "02", name: "Verifica si hay productos sin stock con some", diff: "easy", minutes: 5, href: "/problems/typescript-verifica-productos-sin-stock" },
    { num: "03", name: "Valida que todos los campos del formulario estén llenos", diff: "med", minutes: 8, href: "/problems/typescript-valida-campos-formulario" },
    { num: "04", name: "Implementa una búsqueda con múltiples criterios", diff: "hard", minutes: 12, href: "/problems/typescript-busqueda-multiples-criterios" },
  ]}
/>
</Section>
