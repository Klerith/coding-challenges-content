...
<ExerciseGrid
  items={[
    ...
    { num: "05", name: "Clasifica funciones puras e impuras", diff: "easy", minutes: 5, href: "/problems/typescript-clasifica-pura-impura" },
    { num: "06", name: "Convierte una función impura a función pura", diff: "easy", minutes: 6, href: "/problems/typescript-convierte-impura-a-pura" },
    { num: "07", name: "Refactoriza side effects fuera de una función", diff: "med", minutes: 8, href: "/problems/typescript-refactoriza-side-effects" },
    { num: "08", name: "Verifica que una función es pura con tests", diff: "med", minutes: 8, href: "/problems/typescript-verifica-pureza-tests" },
  ]}
/>
</Section>
