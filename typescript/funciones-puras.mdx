...
<ExerciseGrid
  items={[
    { num: "01", name: "Identifica cuáles funciones son puras", diff: "easy", minutes: 5 },
    { num: "02", name: "Convierte función impura en pura extrayendo side effects", diff: "med", minutes: 8 },
    { num: "03", name: "Refactoriza módulo para aislar side effects", diff: "med", minutes: 10 },
    { num: "04", name: "Escribe tests para funciones puras", diff: "med", minutes: 8 },
  ]}
/>
</Section>
