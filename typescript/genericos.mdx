...
<ExerciseGrid
  items={[
    { num: "01", name: "Implementa una función genérica filter<T>", diff: "med", minutes: 7, href: "/problems/typescript-filter-generico" },
    { num: "02", name: "Crea un tipo ApiResponse<T> y úsalo con 3 entidades", diff: "med", minutes: 8, href: "/problems/typescript-api-response-generica" },
    { num: "03", name: "Implementa un Stack<T> genérico", diff: "hard", minutes: 12, href: "/problems/typescript-stack-generico" },
    { num: "04", name: "Usa keyof y genéricos para deepGet seguro", diff: "hard", minutes: 15, href: "/problems/typescript-deep-get-keyof" },
  ]}
/>
</Section>
