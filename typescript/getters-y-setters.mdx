...
<ExerciseGrid
  items={[
    { num: "01", name: "Getter para nombre completo desde nombre y apellido", diff: "easy", minutes: 5 },
    { num: "02", name: "Setter con validación de edad (0-120)", diff: "easy", minutes: 8 },
    { num: "03", name: "Getter que formatea una fecha legible", diff: "med", minutes: 8 },
    { num: "04", name: "Clase Temperatura con getters Celsius y Fahrenheit", diff: "hard", minutes: 12 },
  ]}
/>
</Section>
