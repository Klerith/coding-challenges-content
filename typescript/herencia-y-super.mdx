...
<ExerciseGrid
  items={[
    { num: "01", name: "Crea Perro y Gato que extienden Animal", diff: "easy", minutes: 8, href: "/problems/typescript-herencia-perro-gato" },
    { num: "02", name: "Override del método toString() usando super", diff: "med", minutes: 10, href: "/problems/typescript-override-tostring-super" },
    { num: "03", name: "Jerarquía de Empleado → Gerente con salario", diff: "med", minutes: 12, href: "/problems/typescript-jerarquia-empleado-gerente" },
    { num: "04", name: "Polimorfismo: array de Animales, cada uno llama sonido()", diff: "hard", minutes: 12, href: "/problems/typescript-polimorfismo-animales" },
  ]}
/>
</Section>
