...
<ExerciseGrid
  items={[
    { num: "01", name: "Implementa tu propio map() desde cero", diff: "med", minutes: 10 },
    { num: "02", name: "Función memoize() genérica", diff: "med", minutes: 10 },
    { num: "03", name: "Implementa pipe() para componer funciones", diff: "hard", minutes: 12 },
    { num: "04", name: "Logger middleware con HOF", diff: "hard", minutes: 12 },
  ]}
/>
</Section>
