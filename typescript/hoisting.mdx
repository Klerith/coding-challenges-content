...
<ExerciseGrid
  items={[
    { num: "01", name: "Predice el output con var hoisting", diff: "easy", minutes: 5 },
    { num: "02", name: "Identifica el error TDZ con let", diff: "easy", minutes: 5 },
    { num: "03", name: "Reescribe código confuso de hoisting de forma clara", diff: "med", minutes: 8 },
    { num: "04", name: "Explica por qué esta función funciona antes de declararse", diff: "med", minutes: 8 },
  ]}
/>
</Section>
