...
<ExerciseGrid
  items={[
    { num: "01", name: "Exporta 3 funciones de utilidad desde un módulo", diff: "easy", minutes: 5 },
    { num: "02", name: "Importa y usa una función de otro módulo", diff: "easy", minutes: 5 },
    { num: "03", name: "Organiza constantes en un módulo separado", diff: "med", minutes: 8 },
    { num: "04", name: "Importa y re-exporta desde un índice", diff: "med", minutes: 8 },
  ]}
/>
</Section>
