...
<ExerciseGrid
  items={[
    { num: "01", name: "Exporta 3 funciones de utilidad desde un módulo", diff: "easy", minutes: 5, href: "/problems/typescript-exporta-tres-funciones" },
    { num: "02", name: "Importa y usa una función de otro módulo", diff: "easy", minutes: 5, href: "/problems/typescript-importa-funcion-modulo" },
    { num: "03", name: "Organiza constantes de configuración en un módulo", diff: "med", minutes: 8, href: "/problems/typescript-organiza-constantes-config" },
    { num: "04", name: "Importa y re-exporta funciones desde un índice", diff: "med", minutes: 8, href: "/problems/typescript-reexporta-desde-indice" },
  ]}
/>
</Section>
