...
<ExerciseGrid
  items={[
    { num: "01", name: "Actualiza un objeto inmutablemente con spread", diff: "easy", minutes: 5, href: "/problems/typescript-actualiza-objeto-spread" },
    { num: "02", name: "Transforma un array sin mutarlo", diff: "easy", minutes: 5, href: "/problems/typescript-transforma-array-sin-mutar" },
    { num: "03", name: "Implementa un reducer puro (patrón Redux)", diff: "med", minutes: 10, href: "/problems/typescript-reducer-puro" },
    { num: "04", name: "Deep freeze de un objeto anidado", diff: "hard", minutes: 12, href: "/problems/typescript-deep-freeze-objeto" },
  ]}
/>
</Section>
