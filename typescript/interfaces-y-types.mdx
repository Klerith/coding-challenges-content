...
<ExerciseGrid
  items={[
    { num: "01", name: "Modela una API de productos con interfaces", diff: "easy", minutes: 5 },
    { num: "02", name: "Crea una jerarquía: Entidad → Producto → ProductoFísico", diff: "med", minutes: 7 },
    { num: "03", name: "Usa Pick y Omit para crear vistas de un tipo", diff: "med", minutes: 6 },
    { num: "04", name: "Compara interface vs type en un caso real", diff: "med", minutes: 8 },
  ]}
/>
</Section>
