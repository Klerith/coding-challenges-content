...
<ExerciseGrid
  items={[
    { num: "01", name: "Implementa un rango iterable Range(inicio, fin, paso)", diff: "med", minutes: 10 },
    { num: "02", name: "Generador de Fibonacci infinito con tomar(n)", diff: "med", minutes: 10 },
    { num: "03", name: "Generador como pipeline de transformación lazy", diff: "hard", minutes: 15 },
    { num: "04", name: "Convierte un árbol en iterable depth-first", diff: "hard", minutes: 20 },
  ]}
/>
</Section>
