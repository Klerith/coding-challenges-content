...
<ExerciseGrid
  items={[
    { num: "01", name: "Parsea una respuesta de API JSON", diff: "easy", minutes: 3 },
    { num: "02", name: "Serializa un objeto con formato legible (indent 2)", diff: "easy", minutes: 3 },
    { num: "03", name: "Filtra propiedades con replacer", diff: "med", minutes: 8 },
    { num: "04", name: "Reviver para convertir strings de fecha a Date", diff: "med", minutes: 8 },
  ]}
/>
</Section>
