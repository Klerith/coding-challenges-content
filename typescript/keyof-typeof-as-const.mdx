...
<ExerciseGrid
  items={[
    { num: "01", name: "Función tipada que acepta solo claves válidas de un objeto", diff: "med", minutes: 10, href: "/problems/typescript-keyof-get-property" },
    { num: "02", name: "Enum simulado con as const y keyof typeof", diff: "med", minutes: 10, href: "/problems/typescript-as-const-status-code" },
    { num: "03", name: "Tipo que mapea claves de un objeto a funciones handler", diff: "hard", minutes: 15, href: "/problems/typescript-keyof-describe-config" },
    { num: "04", name: "Valida en tiempo de compilación que una clave existe", diff: "hard", minutes: 15, href: "/problems/typescript-keyof-safe-get" },
  ]}
/>
</Section>
