...
<ExerciseGrid
  items={[
    { num: "01", name: "Cuenta frecuencias de palabras con Map", diff: "easy", minutes: 8 },
    { num: "02", name: "Elimina duplicados de un array con Set", diff: "easy", minutes: 5 },
    { num: "03", name: "Invierte un Map (clave→valor, valor→clave)", diff: "med", minutes: 10 },
    { num: "04", name: "Intersección y diferencia de dos Sets", diff: "med", minutes: 10 },
    { num: "05", name: "Caché LRU simple con Map", diff: "hard", minutes: 15 },
  ]}
/>
</Section>
