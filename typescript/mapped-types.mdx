...
<ExerciseGrid
  items={[
    { num: "01", name: "Implementa makePartial desde cero con mapped type", diff: "med", minutes: 10, href: "/problems/typescript-mapped-make-partial" },
    { num: "02", name: "Crea Nullable que añade null a cada propiedad", diff: "med", minutes: 12, href: "/problems/typescript-mapped-nullable" },
    { num: "03", name: "Mapped type que convierte propiedades a readonly", diff: "hard", minutes: 15, href: "/problems/typescript-mapped-to-readonly" },
    { num: "04", name: "Implementa EventMap con mapped type para event emitter", diff: "hard", minutes: 20, href: "/problems/typescript-mapped-event-flags" },
    { num: "05", name: "Mapped type: convierte métodos síncronos a async", diff: "hard", minutes: 15, href: "/problems/typescript-mapped-type-sync-a-async" },
  ]}
/>
</Section>
