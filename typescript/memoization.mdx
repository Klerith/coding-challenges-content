...
<ExerciseGrid
  items={[
    { num: "01", name: "Memoiza una función Fibonacci recursiva", diff: "med", minutes: 8, href: "/problems/typescript-memo-fibonacci" },
    { num: "02", name: "Función memoize() con TTL (expiración)", diff: "hard", minutes: 15, href: "/problems/typescript-memo-ttl" },
    { num: "03", name: "Memoización con WeakMap para objetos como clave", diff: "hard", minutes: 15, href: "/problems/typescript-memo-weakmap" },
  ]}
/>
</Section>
