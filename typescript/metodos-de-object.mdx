...
<ExerciseGrid
  items={[
    { num: "01", name: "Itera un objeto con Object.entries() y map", diff: "easy", minutes: 5, href: "/problems/typescript-itera-objeto-entries-map" },
    { num: "02", name: "Convierte un Map a objeto con fromEntries", diff: "med", minutes: 8, href: "/problems/typescript-map-a-objeto-fromentries" },
    { num: "03", name: "Filtra propiedades de un objeto por valor", diff: "med", minutes: 8, href: "/problems/typescript-filtra-propiedades-objeto-valor" },
    { num: "04", name: "Crea un merge profundo usando Object.entries", diff: "hard", minutes: 12, href: "/problems/typescript-merge-profundo-object-entries" },
  ]}
/>
</Section>
