...
<ExerciseGrid
  items={[
    { num: "01", name: "Convierte propiedades de CuentaBancaria a private", diff: "easy", minutes: 8 },
    { num: "02", name: "Usa protected para lógica compartida en herencia", diff: "med", minutes: 10 },
    { num: "03", name: "Readonly para propiedades que no deben cambiar", diff: "easy", minutes: 5 },
    { num: "04", name: "Encapsula estado con private y getters públicos", diff: "med", minutes: 12 },
  ]}
/>
</Section>
