...
<ExerciseGrid
  items={[
    { num: "01", name: "Narrowing con typeof en 4 casos", diff: "easy", minutes: 5, href: "/problems/typescript-narrowing-typeof" },
    { num: "02", name: "Type guard para una union discriminada", diff: "med", minutes: 7, href: "/problems/typescript-narrowing-union-discriminada" },
    { num: "03", name: "isDefined genérico para filtrar nulls", diff: "med", minutes: 6, href: "/problems/typescript-isdefined-filtrar-nulls" },
    { num: "04", name: "Validador de respuesta de API con type predicates", diff: "hard", minutes: 12, href: "/problems/typescript-validador-respuesta-api" },
  ]}
/>
</Section>
