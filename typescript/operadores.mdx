...
<ExerciseGrid
  ...
  items={[
    { num: "01", name: "Calculadora básica", diff: "easy", minutes: 3, href: "/problems/typescript-calculadora-cuatro-operadores" },
    { num: "02", name: "Comparaciones con tipos mixtos", diff: "easy", minutes: 3, href: "/problems/typescript-igualdad-estricta" },
    { num: "03", name: "Short-circuit en práctica", diff: "med", minutes: 4, href: "/problems/typescript-short-circuit-and" },
    { num: "04", name: "Nullish coalescing vs OR", diff: "med", minutes: 5, href: "/problems/typescript-nullish-vs-or" },
  ]}
/>
</Section>
