...
<ExerciseGrid
  items={[
    { num: "01", name: "Accede a propiedades anidadas con ?.", diff: "easy", minutes: 3 },
    { num: "02", name: "Usa ?? para defaults más precisos que ||", diff: "easy", minutes: 5 },
    { num: "03", name: "Encadena ?. en una respuesta de API anidada", diff: "med", minutes: 8 },
    { num: "04", name: "Combina ?. y ?? en un accessor seguro", diff: "med", minutes: 8 },
  ]}
/>
</Section>
