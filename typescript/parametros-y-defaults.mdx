...
<ExerciseGrid
  items={[
    { num: "01", name: "Función de saludo con idioma por defecto", diff: "easy", minutes: 3, href: "/problems/typescript-saludo-idioma-default" },
    { num: "02", name: "Config con desestructuración y defaults", diff: "med", minutes: 5, href: "/problems/typescript-destructura-opciones-defaults" },
    { num: "03", name: "Refactoriza patrón || a default nativo", diff: "med", minutes: 4, href: "/problems/typescript-refactoriza-or-a-default" },
    { num: "04", name: "Orden correcto de parámetros con defaults", diff: "easy", minutes: 3, href: "/problems/typescript-orden-parametros-defaults" },
  ]}
/>
</Section>
