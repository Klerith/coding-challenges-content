...
<ExerciseGrid
  items={[
    { num: "01", name: "Implementa un EventEmitter simple (on/off/emit)", diff: "med", minutes: 12, href: "/problems/typescript-patron-event-emitter" },
    { num: "02", name: "Factory que crea distintos tipos de usuario", diff: "easy", minutes: 8, href: "/problems/typescript-patron-factory-usuario" },
    { num: "03", name: "Singleton de configuración global", diff: "med", minutes: 10, href: "/problems/typescript-patron-singleton-config" },
    { num: "04", name: "Strategy para distintos algoritmos de ordenamiento", diff: "hard", minutes: 15, href: "/problems/typescript-patron-strategy-sort" },
  ]}
/>
</Section>
