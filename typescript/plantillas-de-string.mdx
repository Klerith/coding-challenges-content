...
<ExerciseGrid
  items={[
    { num: "01", name: "Convierte concatenaciones a template literals", diff: "easy", minutes: 3, href: "/problems/typescript-concatenacion-a-template-literal" },
    { num: "02", name: "Genera un recibo multilínea", diff: "easy", minutes: 4, href: "/problems/typescript-recibo-multilinea" },
    { num: "03", name: "Template con expresión condicional", diff: "med", minutes: 5, href: "/problems/typescript-template-con-ternario" },
  ]}
/>
</Section>
