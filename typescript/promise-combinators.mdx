...
<ExerciseGrid
  items={[
    { num: "01", name: "Carga 3 recursos en paralelo con Promise.all", diff: "med", minutes: 8 },
    { num: "02", name: "Usa allSettled para reportar éxitos y fallos", diff: "med", minutes: 8 },
    { num: "03", name: "Implementa un timeout con Promise.race", diff: "hard", minutes: 12 },
    { num: "04", name: "Encuentra el servidor más rápido con Promise.any", diff: "hard", minutes: 12 },
  ]}
/>
</Section>
