...
<ExerciseGrid
  items={[
    { num: "01", name: "Envuelve setTimeout en una Promise", diff: "easy", minutes: 5 },
    { num: "02", name: "Encadena 3 promesas de transformación de datos", diff: "med", minutes: 8 },
    { num: "03", name: "Maneja errores con catch en una cadena", diff: "easy", minutes: 5 },
    { num: "04", name: "Crea una función retry con Promise", diff: "hard", minutes: 15 },
    { num: "05", name: "Implementa un delay() reutilizable con Promise", diff: "med", minutes: 7 },
  ]}
/>
</Section>
