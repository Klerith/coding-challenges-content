...
<ExerciseGrid
  items={[
    { num: "01", name: "Traza la cadena de prototype de un array", diff: "med", minutes: 10, href: "/problems/typescript-traza-cadena-prototype" },
    { num: "02", name: "Implementa herencia con Object.create() sin clases", diff: "hard", minutes: 15, href: "/problems/typescript-herencia-object-create" },
    { num: "03", name: "Agrega un método a Array.prototype (y por qué no hacerlo en producción)", diff: "hard", minutes: 15, href: "/problems/typescript-custom-map-prototype" },
  ]}
/>
</Section>
