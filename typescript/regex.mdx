...
<ExerciseGrid
  items={[
    { num: "01", name: "Valida un email con regex", diff: "med", minutes: 8, href: "/problems/typescript-regex-valida-email" },
    { num: "02", name: "Extrae todos los números de un string", diff: "easy", minutes: 5, href: "/problems/typescript-regex-extrae-numeros" },
    { num: "03", name: "Reemplaza múltiples espacios por uno solo", diff: "easy", minutes: 5, href: "/problems/typescript-regex-normaliza-espacios" },
    { num: "04", name: "Parsea una URL en sus componentes con regex", diff: "hard", minutes: 15, href: "/problems/typescript-regex-parsea-url" },
  ]}
/>
</Section>
