...
<ExerciseGrid
  items={[
    { num: "01", name: "Función que acepta N números y retorna su suma", diff: "easy", minutes: 3 },
    { num: "02", name: "Combina dos arrays sin duplicados", diff: "med", minutes: 5 },
    { num: "03", name: "Omite propiedades de un objeto con rest", diff: "med", minutes: 4 },
    { num: "04", name: "Deep merge de objetos con spread", diff: "med", minutes: 7 },
  ]}
/>
</Section>
