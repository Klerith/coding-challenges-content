...
<ExerciseGrid
  items={[
    { num: "01", name: "Identifica qué scope tiene cada variable", diff: "easy", minutes: 5 },
    { num: "02", name: "Corrige un bug de scope con let vs var", diff: "med", minutes: 8 },
    { num: "03", name: "Crea un módulo privado con IIFE", diff: "med", minutes: 10 },
    { num: "04", name: "Explica el output de esta scope chain", diff: "hard", minutes: 12 },
  ]}
/>
</Section>
