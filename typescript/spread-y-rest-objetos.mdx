...
<ExerciseGrid
  items={[
    { num: "01", name: "Fusiona dos objetos de configuración", diff: "easy", minutes: 5 },
    { num: "02", name: "Actualiza una propiedad inmutablemente con spread", diff: "easy", minutes: 5 },
    { num: "03", name: "Extrae campos sensibles de un objeto con rest", diff: "med", minutes: 8 },
    { num: "04", name: "Deep merge manual de objetos anidados", diff: "hard", minutes: 12 },
  ]}
/>
</Section>
