...
<ExerciseGrid
  items={[
    { num: "01", name: "Crea un contador de instancias con static", diff: "easy", minutes: 8, href: "/problems/typescript-contador-instancias-static" },
    { num: "02", name: "Factory method estático para crear instancias", diff: "med", minutes: 10, href: "/problems/typescript-factory-method-static" },
    { num: "03", name: "Constantes estáticas en una clase de configuración", diff: "easy", minutes: 5, href: "/problems/typescript-constantes-static-readonly" },
    { num: "04", name: "Singleton con static instance privado", diff: "hard", minutes: 12, href: "/problems/typescript-singleton-static" },
  ]}
/>
</Section>
