...
<ExerciseGrid
  items={[
    { num: "01", name: "Usa Symbol para crear propiedades privadas en un objeto", diff: "med", minutes: 10 },
    { num: "02", name: "Implementa Symbol.toPrimitive en una clase Vector2D", diff: "hard", minutes: 15 },
    { num: "03", name: "Usa Symbol.iterator para hacer un objeto árbol iterable", diff: "hard", minutes: 15 },
  ]}
/>
</Section>
