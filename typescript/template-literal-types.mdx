...
<ExerciseGrid
  items={[
    { num: "01", name: "Tipo EventName que produce 'on' + Capitalize con template literals", diff: "med", minutes: 10, href: "/problems/typescript-template-literal-event-name" },
    { num: "02", name: "Rutas de API tipadas con template literals y métodos HTTP", diff: "med", minutes: 12, href: "/problems/typescript-template-literal-api-path" },
    { num: "03", name: "Getter y setter genérico tipado con template literal types", diff: "hard", minutes: 15, href: "/problems/typescript-template-literal-getter-setter" },
  ]}
/>
</Section>
