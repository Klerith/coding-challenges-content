...
<ExerciseGrid
  items={[
    { num: "01", name: "Identifica el valor de this en cada contexto", diff: "med", minutes: 8, href: "/problems/typescript-this-contextos" },
    { num: "02", name: "Corrige un método que pierde this en setTimeout", diff: "med", minutes: 10, href: "/problems/typescript-bind-metodo" },
    { num: "03", name: "Implementa bind() manualmente desde cero", diff: "hard", minutes: 15, href: "/problems/typescript-mybind-manual" },
    { num: "04", name: "Usa call() para reutilizar un método entre objetos", diff: "hard", minutes: 12, href: "/problems/typescript-call-borrow-method" },
  ]}
/>
</Section>
