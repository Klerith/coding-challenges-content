...
<ExerciseGrid
  items={[
    { num: "01", name: "Valida un argumento con throw", diff: "easy", minutes: 5, href: "/problems/typescript-valida-argumento-throw" },
    { num: "02", name: "Propaga un error a través de funciones", diff: "med", minutes: 8, href: "/problems/typescript-propaga-error-funciones" },
    { num: "03", name: "Re-lanza solo errores específicos", diff: "med", minutes: 10, href: "/problems/typescript-relanza-errores-especificos" },
    { num: "04", name: "Valida datos con throw en cada campo", diff: "hard", minutes: 12, href: "/problems/typescript-valida-datos-throw-campos" },
  ]}
/>
</Section>
