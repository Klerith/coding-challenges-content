...
<ExerciseGrid
  items={[
    { num: "01", name: "Anota tipos en variables existentes", diff: "easy", minutes: 3 },
    { num: "02", name: "Función con parámetros opcionales", diff: "easy", minutes: 4 },
    { num: "03", name: "Crea un type alias para coordenadas GPS", diff: "med", minutes: 5 },
    { num: "04", name: "Convierte código JS a TS con tipos correctos", diff: "med", minutes: 7 },
  ]}
/>
</Section>
