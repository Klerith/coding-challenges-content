...
<ExerciseGrid
  items={[
    { num: "01", name: "Parsea JSON sin romper la app", diff: "easy", minutes: 5, href: "/problems/typescript-parsea-json-sin-romper" },
    { num: "02", name: "Libera recursos con finally", diff: "easy", minutes: 5, href: "/problems/typescript-libera-recursos-finally" },
    { num: "03", name: "Maneja múltiples tipos de error", diff: "med", minutes: 8, href: "/problems/typescript-maneja-multiples-tipos-error" },
    { num: "04", name: "Función safe que nunca lanza", diff: "med", minutes: 8, href: "/problems/typescript-funcion-safe-nunca-lanza" },
  ]}
/>
</Section>
