...
<ExerciseGrid
  items={[
    { num: "01", name: "Modelo de API: éxito | error con union discriminada", diff: "med", minutes: 6, href: "/problems/typescript-api-union-discriminada" },
    { num: "02", name: "Sistema de formas con área exhaustiva", diff: "med", minutes: 8, href: "/problems/typescript-formas-area-exhaustiva" },
    { num: "03", name: "Combina roles de usuario con intersecciones", diff: "med", minutes: 7, href: "/problems/typescript-roles-interseccion" },
    { num: "04", name: "Narrowing con predicados de tipo (is)", diff: "hard", minutes: 10, href: "/problems/typescript-narrowing-predicados-tipo" },
  ]}
/>
</Section>
