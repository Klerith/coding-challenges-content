...
<ExerciseGrid
  items={[
    { num: "01", name: "Usa Partial para un formulario de edición de perfil", diff: "easy", minutes: 8 },
    { num: "02", name: "Crea un DTO sin campos sensibles con Omit", diff: "med", minutes: 10 },
    { num: "03", name: "Record para un mapa de rutas con sus configuraciones", diff: "med", minutes: 10 },
    { num: "04", name: "ReturnType y Awaited para inferir tipos de API calls", diff: "hard", minutes: 15 },
    { num: "05", name: "Combina Pick + Partial para un update tipo PATCH", diff: "hard", minutes: 15 },
  ]}
/>
</Section>
