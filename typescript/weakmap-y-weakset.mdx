...
<ExerciseGrid
  items={[
    { num: "01", name: "Usa WeakMap para metadata privada de objetos DOM", diff: "med", minutes: 10 },
    { num: "02", name: "Detecta objetos ya procesados con WeakSet", diff: "med", minutes: 10 },
    { num: "03", name: "¿Por qué este código con Map produce leak? — análisis y corrección", diff: "hard", minutes: 15 },
  ]}
/>
</Section>
